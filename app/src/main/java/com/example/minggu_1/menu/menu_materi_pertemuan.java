...
public class menu_materi_pertemuan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        materi[] myListData = new materi[]{
                ...
                new materi("Minggu Ke-4","","19-April-2021","ProgressBar,Listview,RecyclerView dan Webview"),
                new materi("Minggu Ke-5","","19-April-2021","ProgressBar,Listview,RecyclerView dan Webview"),
